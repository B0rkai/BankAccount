...
enum ImportColumnsMBH {
	...
	MBH_Column_Ugyfelazonosito,
	MBH_Column_KedvezmenyezettTranzakcioazonositoja,
	MBH_Column_SzamlaAzonosito,
	MBH_Column_TorzsvasarloAzonosito,
	MBH_Column_KereskedoiEszkozAzonosito,
	MBH_Column_NavEllenorzoKod,
	MBH_Column_BoltAzonosito,
...
static void ImportFromCSV(const String& filename, RawImportData& import_data) {
	...
	if (data.front().front() == L"Számlatörténet") {
